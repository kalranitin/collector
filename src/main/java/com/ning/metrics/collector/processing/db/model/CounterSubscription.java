...
public class CounterSubscription
{
    ...
    @JsonCreator
    public CounterSubscription(@JsonProperty("appId") final String appId, @JsonProperty("timezone") final String timezone, @JsonProperty("identifierDistribution") final ArrayListMultimap<Integer, String> identifierDistribution)
    {
        this.appId = appId;
