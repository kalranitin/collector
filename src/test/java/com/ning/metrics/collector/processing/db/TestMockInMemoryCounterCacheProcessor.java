...
public class TestMockInMemoryCounterCacheProcessor
{
    ...
    public void testAddCounterEventDataWithExpire() throws Exception{
        ...
        Mockito.verify(counterStorage,Mockito.times(1)).insertDailyMetrics(Mockito.<Multimap<Long, CounterEventData>>any());
        Mockito.verify(counterStorage, Mockito.timeout(1000).times(1)).insertDailyMetrics(Mockito.<Multimap<Long, CounterEventData>>any());
    }
...
//        Mockito.verify(counterStorage,Mockito.times(1)).insertDailyMetrics(Mockito.<Multimap<Long, CounterEventData>>any());
        ...
        Mockito.verify(counterStorage, Mockito.timeout(2000).atLeastOnce()).insertDailyMetrics(Mockito.<Multimap<Long, CounterEventData>>any());
